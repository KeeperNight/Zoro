...
#feedback-note-tmp:focus,#feedback-overview-note:focus{border:1px solid #64b7cc;background-color: #111;color:whitesmoke;}
#feedback-canvas{position:absolute;top:0;left:0;}
#feedback-welcome{top:30%;left:50%;margin-left:-270px;display:block;position:fixed; background-color:#111;color:whitesmoke;}
...
#feedback-note-tmp,#feedback-overview-note{resize:none; background-color: #111;color:whitesmoke;}
#feedback-welcome,#feedback-highlighter,#feedback-overview,#feedback-submit-success,#feedback-submit-error{font-family:Arial,sans-serif;z-index:40000;background:#fff;border:1px solid rgba(0,0,0,.333);padding:30px 42px;width:540px;border:1px solid rgba(0,0,0,.333);outline:0;-webkit-box-shadow:0 4px 16px rgba(0,0,0,.2);-moz-box-shadow:0 4px 16px rgba(0,0,0,.2);box-shadow:0 4px 16px rgba(0,0,0,.2);background:#fff;background-clip:padding-box;box-sizing: border-box;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;-webkit-transform: translateZ(0);background-color:#111;color:whitesmoke;border-radius:0px;}
...
#feedback-overview-description{float:left; color:whitesmoke;}
...
#feedback-overview-description-text span{font-size:14px;margin:8px 0;color:#eee;padding-left:10px;background:url(icons.png) -30px -34px no-repeat;margin-left:26px;}
#feedback-browser-info,#feedback-page-info,#feedback-page-structure,#feedback-additional-none{margin-top:16px;color:whitesmoke;}
#feedback-user-email, #feedback-note-tmp{
    border-radius: 12px;
    box-shadow: 9px 9px 16px rgb(255,255,255,0.05), -9px -9px 16px    rgba(0, 0, 0, 0.6);
