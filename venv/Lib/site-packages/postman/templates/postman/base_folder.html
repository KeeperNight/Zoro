{% extends "postman/post_base.html" %}
...
{% block pm_delete_button %}<button type="submit" class="pm_btn pm_btn-delete" onclick="this.form.action='{% url 'postman:delete' %}'"><i class="far fa-trash-alt"></i></button>{% endblock %}
{% block pm_archive_button %}<button type="submit" class="pm_btn pm_btn-archive" onclick="this.form.action='{% url 'postman:archive' %}'"><i class="fas fa-archive"></i></button>{% endblock %}
...
{% block pm_read_button %}<button type="submit" class="pm_btn pm_btn-read" onclick="this.form.action='{% url 'postman:mark-read' %}'"><i class="fas fa-check-double"></i></button>{% endblock %}
